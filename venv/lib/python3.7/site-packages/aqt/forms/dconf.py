...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_22.setText(_("Description to show on overview screen, for current deck:"))
